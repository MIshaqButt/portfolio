...
class AnimatedLineThroughText extends StatefulWidget {
  const AnimatedLineThroughText({
    ...
    this.hoverColor = ColorName.black,
    this.coverColor = ColorName.primaryColor,
    this.slideBoxColor = ColorName.black, this.slideBoxCoverColor = ColorName.primaryColor,
    this.onTap,
    this.heightFactor= 1,
    this.widthFactor= 1,
    this.maxLines = 1,
  ...
  @override
  AnimatedLineThroughTextState createState() =>
      AnimatedLineThroughTextState();
}
