...
class ProjectItem extends StatelessWidget {
  const ProjectItem({
    ...
    this.subtitleStyle,
    this.titleStyle,
    this.indicatorColor = ColorName.grey550,
    this.indicatorHeight = Sizes.height1,
    this.indicatorWidth = Sizes.width150,
...
class ProjectItemLg extends StatefulWidget {
  const ProjectItemLg({
    ...
    this.backgroundOnHoverColor = ColorName.primaryColor,
    this.backgroundColor = ColorName.accentColor2,
    this.projectNumberStyle,
    this.subtitleStyle,
    this.titleStyle,
  ...
  @override
  ProjectItemLgState createState() => ProjectItemLgState();
}

class ProjectItemLgState extends State<ProjectItemLg>
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? defaultNumberStyle = widget.projectNumberStyle ??
        textTheme.titleLarge?.copyWith(
          fontSize: _isHovering ? Sizes.textSize20 : Sizes.textSize16,
          ...
          children: [
            ...
            Positioned(
              ...
              child: AnimatedBubbleButton(
                ...
                title: StringConst.viewProject.toUpperCase(),
...
class ProjectItemSmState extends State<ProjectItemSm>
    with SingleTickerProviderStateMixin {
  bool _isHovering = false;
  late AnimationController _controller;
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? defaultNumberStyle = widget.projectNumberStyle ??
        textTheme.titleLarge?.copyWith(
          fontSize: _isHovering ? Sizes.textSize18 : Sizes.textSize16,
          color: ColorName.grey550,
          fontWeight: _isHovering ? FontWeight.w400 : FontWeight.w300,
        );
    // textStyle for the title or name of the project
