...
class AeriumButton extends StatefulWidget {
  const AeriumButton({
    ...
    required this.title,
    this.titleStyle,
    this.width = Sizes.width120,
    this.borderWidth = Sizes.width1,
    this.height = Sizes.height44,
    this.onPressed,
    this.hasIcon = true,
    this.iconColor = ColorName.white,
    this.buttonColor = ColorName.black,
    this.borderColor = ColorName.black,
    this.onHoverColor = ColorName.white,
  ...
  @override
  AeriumButtonState createState() => AeriumButtonState();
}

class AeriumButtonState extends State<AeriumButton>
