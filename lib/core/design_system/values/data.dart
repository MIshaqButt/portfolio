...
import 'package:m_ishaq_butt/core/design_system/values/images.dart';
...
import 'package:m_ishaq_butt/presentation/widgets/nav_item.dart';
...
class Projects {
  static ProjectItemData DISNEY_PLUS = ProjectItemData(
    ...
    primaryColor: ColorName.disneyPlus,
    image: ImagePath.DISNEY_PLUS_COVER,
    coverUrl: ImagePath.DISNEY_PLUS_SCREENS,
    navSelectedTitleColor: ColorName.flutterCatalogSelectedNavTitle,
    appLogoColor: ColorName.flutterCatalogAppLogo,
    projectAssets: [
  ...
  static ProjectItemData FLUTTER_CATALOG = ProjectItemData(
    ...
    primaryColor: ColorName.flutterCatalog,
  ...
  static ProjectItemData DROP = ProjectItemData(
    ...
    navTitleColor: ColorName.dropNavTitle,
    navSelectedTitleColor: ColorName.dropSelectedNavTitle,
    appLogoColor: ColorName.dropAppLogo,
    projectAssets: [
      ImagePath.DROP_DESC,
  ...
  static ProjectItemData ROAM = ProjectItemData(
    ...
    navTitleColor: ColorName.roamNavTitle,
    navSelectedTitleColor: ColorName.roamSelectedNavTitle,
    appLogoColor: ColorName.roamAppLogo,
    projectAssets: [
  ...
  static ProjectItemData LOGIN_CATALOG = ProjectItemData(
    ...
    primaryColor: ColorName.loginCatalog,
    ...
    navTitleColor: ColorName.loginCatalogNavTitle,
    navSelectedTitleColor: ColorName.loginCatalogSelectedNavTitle,
    appLogoColor: ColorName.loginCatalogAppLogo,
    projectAssets: [
  ...
  static ProjectItemData FOODY_BITE = ProjectItemData(
    ...
    primaryColor: ColorName.foodybite,
    platform: StringConst.FOODY_BITE_PLATFORM,
    image: ImagePath.FOODY_BITE_COVER,
    coverUrl: ImagePath.FOODY_BITE_COVER,
    navTitleColor: ColorName.foodybiteNavTitle,
    navSelectedTitleColor: ColorName.foodybiteSelectedNavTitle,
    appLogoColor: ColorName.foodybiteAppLogo,
    projectAssets: [
  ...
  static ProjectItemData NIMBUS = ProjectItemData(
    ...
    navTitleColor: ColorName.nimbusNavTitle,
    navSelectedTitleColor: ColorName.nimbusSelectedNavTitle,
    projectAssets: [
      ImagePath.NIMBUS,
    ],
  ...
  static ProjectItemData OTP_TEXT_FIELD = ProjectItemData(
    ...
    primaryColor: ColorName.otpPackage,
    ...
    navTitleColor: ColorName.otpPackageNavTitle,
    navSelectedTitleColor: ColorName.otpPackageSelectedNavTitle,
    appLogoColor: ColorName.otpPackageAppLogo,
    isPublic: true,
    isLive: true,
    technologyUsed: StringConst.FLUTTER,
  ...
  static ProjectItemData AERIUM = ProjectItemData(
    ...
    primaryColor: ColorName.aeriumV1,
    ...
    navTitleColor: ColorName.aeriumV1NavTitle,
    projectAssets: [
  ...
  static ProjectItemData OUTFITR = ProjectItemData(
    ...
    primaryColor: ColorName.outfitr,
    ...
    navTitleColor: ColorName.outfitrNavTitle,
    navSelectedTitleColor: ColorName.outfitrSelectedNavTitle,
    appLogoColor: ColorName.outfitrAppLogo,
    projectAssets: [
      ImagePath.OUTFITR_2,
      ImagePath.OUTFITR_4,
      ImagePath.OUTFITR_5,
